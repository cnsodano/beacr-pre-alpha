...
# beacr <img src="man/figures/logo.png" align="right" height="120" alt="" />
...
See [this vignette](basic_usage.html) for more examples of typical usage
patterns
...
suggest that mixing (or *`beacr::swirl`ing*) beacons together provide a
more robust seed generation method in the event that any one beacon
becomes unreliable. In future versions, I hope to implement additional
beacons, and I welcome contributions to this end. Other beacons
